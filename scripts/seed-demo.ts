...
async function seed(cfg: AirtableConfig) {
  ...
  const tasks = [
    ...
    { deal: 'cascade-sales' as DealKey, title: 'Follow up — decision date passed', due: day(0), stage: 'qualified' as const, source: 'timer' as const, done: false },
    { deal: 'cascade-sales' as DealKey, title: 'Send proposal', due: day(-12), stage: 'qualified' as const, source: 'stage-packet' as const, done: true },
    { deal: 'bluepeak-stale' as DealKey, title: 'Decide whether to release the hold', due: day(1), stage: 'qualified' as const, source: 'timer' as const, done: false },
